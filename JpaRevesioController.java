package com.example.jparevesion.controllers;
...
import com.example.jparevesion.repositories.AccountRepository;

@Controller
public class JpaRevesioController {
	@Autowired
	...
	public String homePage()
	{
		...
		System.out.println(accRepo.existsByAccnm("shrutesh"));
		List<Account> list=accRepo.findByBalanceBetween(20000, 40000);
